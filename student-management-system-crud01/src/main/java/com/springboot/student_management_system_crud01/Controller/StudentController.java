package com.springboot.student_management_system_crud01.Controller;
...
import com.springboot.student_management_system_crud01.Service.StudentService;
...
public class StudentController {
	...
	String getAllStudents(Model model) {
		// create a model to send data betn view and controller
